  ...
  return (
    <Switch>
      ...
      <Route path="/donor/medical-form">
        <ProtectedRoute roles={["donor"]}><MedicalForm /></ProtectedRoute>
      </Route>
      <Route path="/donor/appointments">
        <ProtectedRoute roles={["donor"]}><DonorAppointments /></ProtectedRoute>
      </Route>
      <Route path="/donor/history">
        <ProtectedRoute roles={["donor"]}><DonationHistory /></ProtectedRoute>
      </Route>
      <Route path="/donor/notifications">
        <ProtectedRoute roles={["donor"]}><DonorNotifications /></ProtectedRoute>
      </Route>

      {/* Center */}
      <Route path="/center/dashboard">
        <ProtectedRoute roles={["transfusion_center", "blood_bank"]}><CenterDashboard /></ProtectedRoute>
      </Route>
      <Route path="/center/donors">
        <ProtectedRoute roles={["transfusion_center", "blood_bank"]}><CenterDonors /></ProtectedRoute>
      </Route>
      <Route path="/center/appointments">
        <ProtectedRoute roles={["transfusion_center", "blood_bank"]}><CenterAppointments /></ProtectedRoute>
      </Route>
      <Route path="/center/collection">
        <ProtectedRoute roles={["transfusion_center"]}><CenterCollection /></ProtectedRoute>
      </Route>
      <Route path="/center/reception">
        <ProtectedRoute roles={["blood_bank"]}><CenterReception /></ProtectedRoute>
      </Route>
      <Route path="/center/stock">
        <ProtectedRoute roles={["transfusion_center", "blood_bank"]}><CenterStock /></ProtectedRoute>
      </Route>
      <Route path="/center/requests">
        <ProtectedRoute roles={["transfusion_center", "blood_bank"]}><CenterRequests /></ProtectedRoute>
      </Route>
      <Route path="/center/deliveries">
        <ProtectedRoute roles={["transfusion_center"]}><CenterDeliveries /></ProtectedRoute>
      </Route>
      ...
      <Route path="/establishment/request">
        <ProtectedRoute roles={["hospital", "clinic"]}><EstablishmentRequest /></ProtectedRoute>
      </Route>
      <Route path="/establishment/tracking">
        <ProtectedRoute roles={["hospital", "clinic"]}><EstablishmentTracking /></ProtectedRoute>
      </Route>
      <Route path="/establishment/invoices">
        <ProtectedRoute roles={["clinic"]}><EstablishmentInvoices /></ProtectedRoute>
      </Route>
