  ...
  return (
    <Layout>
      <div className="p-6 max-w-2xl mx-auto space-y-6">
        <div>
          <h1 className="text-2xl font-bold text-foreground">Demande de sang</h1>
        ...
        <AnimatePresence mode="wait">
          {submitted ? (
            <motion.div key="success" initial={{ opacity: 0, scale: 0.95 }} animate={{ opacity: 1, scale: 1 }}
              ...
              <p className="text-green-700 mb-1">Votre demande a été transmise au Centre National de Transfusion Sanguine.</p>
              <p className="text-green-700/70 text-sm mb-6">Vous recevrez une notification dès qu'elle sera traitée.</p>
              <div className="flex gap-3 justify-center">
                <Button className="bg-primary text-white hover:bg-primary/90" onClick={() => window.location.href = "/establishment/tracking"}>Suivre la demande</Button>
            ...
            <motion.div key="form" initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
              <form onSubmit={handleSubmit} className="space-y-5">
                {/* Blood type */}
                <Card>
                  <CardHeader className="pb-3"><CardTitle className="text-base flex items-center gap-2"><Droplet className="w-5 h-5 text-primary" />Groupe sanguin requis</CardTitle></CardHeader>
                  <CardContent>
                ...
                <div className="bg-blue-50 border border-blue-200 rounded-xl p-4 flex items-start gap-3">
                  ...
                  <div className="text-sm text-blue-800">
                    <p className="font-semibold mb-1">Routage automatique</p>
                    <p>Votre demande sera automatiquement envoyée au <strong>Centre National de Transfusion Sanguine</strong>. En cas de pénurie, elle sera redirigée vers le centre régional le plus proche.</p>
                  </div>
                </div>
